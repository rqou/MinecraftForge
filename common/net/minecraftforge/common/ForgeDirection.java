...
public enum ForgeDirection
{
    ...
    public static final int[] ccwX = new int[] { 5, 4, 2, 3, 0, 1, 6};
    ...
    public static final int[] ccwY = new int[] { 0, 1, 4, 5, 3, 2, 6};
    ...
    public static final int[] ccwZ = new int[] { 3, 2, 0, 1, 4, 5, 6};
